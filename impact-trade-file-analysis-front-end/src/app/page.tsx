...
export default async function Home() {
    ...
    return (
        <main>
            <div className="container relative h-screen flex-col items-center justify-center md:grid lg:max-w-none dark:bg-dot-white/20 bg-dot-black/20 lg:grid-cols-2 lg:px-0">
                <div className="relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
                    <div className="absolute inset-0 bg-zinc-900 bg-grid-small-white/20" />
